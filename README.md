...
* `FORCE_SUB_CHANNEL` Optional (legacy): Single ForceSub chat ID, leave 0 to disable.
* `FORCE_SUB_CHANNELS` Optional: Space/comma separated list of ForceSub chat IDs (channels/groups).
...
* `JOIN_REQUEST_ENABLED` Optional: Set to "True" to enable join request invite links for ForceSub chats. Default is "False".
